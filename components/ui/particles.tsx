...
export default function Particles({ className = "", quantity = 30, staticity = 50, ease = 50, color = "#ffffff" }: ParticlesProps) {
	...
	const onMouseMove = () => {
		if (canvasRef.current) {
			...
			const { clientX, clientY } = { clientX: mouse.current.x, clientY: mouse.current.y };
